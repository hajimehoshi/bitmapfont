...
//go:generate go1.11rc1 run ./hangul/main.go -output /tmp/hangul.png
//go:generate go1.11rc1 run gen.go -input mplus.png -inputhangul /tmp/hangul.png -output /tmp/compressedFontRGBA
